...
const Card = () => {
  ...
  <div className="max-w-[1194px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-[50px] px-4">
    ...
    <div className="w-full max-w-[572px]  bg-[#F4F4F4] rounded-[20px] flex flex-col items-center justify-center text-center mx-auto">
      ...
      <p className="text-[16px] mt-[36px] font-normal text-[#545454] leading-[170%] max-w-[476px] p-4">
    ...
    {/* Right */}
     <div className="w-full max-w-[572px]  bg-[#1090CB] text-white rounded-[20px] flex flex-col items-center justify-center text-center mx-auto">
      <h1 className="text-[25px]  leading-[170%] mt-[64px] font-semibold max-w-[365px]">Lorem ipsum is simply dummy text</h1>
      <p className="text-[16px] mt-[36px] font-normal text-white leading-[170%] max-w-[476px] p-4">
         KODEX TECHNOLOGY (PVT) LTD is a team of experienced mobile and web
              applications and website builders measuring dozens of completed
              projects. We build and develop mobile applications for several top
              platforms, including Android & IOS.
