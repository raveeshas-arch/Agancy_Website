...
const Mobile1 = () => {
  return (
    <section
      id="about"
      className="flex flex-col lg:flex-row  mt-[55px] lg:ml-[123px] md:text-left text-center p-2  justify-center items-center"
    >
      {/* Left */}
      ...
      <div className=" flex mt-[55px]  ">
        <img src={img7} alt="mobile" className="w-[803px]  " />
      </div>
    </section>
  );
};
