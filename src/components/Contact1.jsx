...
const Contact1 = () => {
  return (
    <div className="w-full mb-[53px] max-w-[1536px] mx-auto" id="contact" >
         <div className="lg:flex justify-around sm:grid grid-cols-1  text-center items-center md:text-left">
           
           {/* Logo  */}
           <div className='lg:ml-[101px] max-w-[372px]'>
           ...
           <div className='mt-[87px] lg:ml[140px] max-w-[372px] '>
             ...
             <p className='max-w-[90px] mt-[15px] text-[#515151] leading-[186%]'> Lorem
Portfolio
Careers
Contact us</p>
           </div>
           ...
           {/* Social icons */}
             ...
             <div className='flex gap-[16px] mt-[200px]  '>
